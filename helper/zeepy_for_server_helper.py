...
class ZeepyForServerHelper:
    def __init__(self):
        ...
        self.token = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ6eDY0ODZAZ21haWwuY29tIiwiaWF0IjoxNjMxMTA0MjAwLCJleHAiOjE2MzExOTA2MDB9.s2UokNLh1VrV_TaTBTzhngaW-RtC8giEXYD3V_msC_A"
